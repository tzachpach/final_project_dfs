...
model_configs = [
    ...
    #         [0.95, 0.8, 0.0],  # top‑5% / mid-15% / rest # removed second binning splits for speed
    #     ],
    #     # ── Mode toggle (2) ──────────────────────────────────────────────
    #     "mode": ["weekly", "daily"],  # ← both evaluated
    #     # Look‑back windows (1 each → they do **not** multiply)
    #     "train_window_days": [20, 60],  # was [20, 60] # used only when mode == "daily"
    #     "train_window_weeks": [4, 8],  # was [4, 8]   # used only when mode == "weekly"
    #     "save_model": [True],
